...
$('.link-modal__item .link-modal__option span').on('click', function () {
  $('#js-link-modal').removeAttr('class').removeClass('link-modal--active').addClass('link-modal');
});
...
function deliveryMethod($this, wrapOne, wrapTwo, textOne, textTwo, term) {
  ...
  textOne.removeClass('checkout__text-span--active');
  textTwo.addClass('checkout__text-span--active');
  b = term ? btnTwo.addClass('btn-dis') : btnTwo.removeClass('btn-dis');
}
...
$('.link-modal__item').on('click', function () {
  ...
  if (spanVal == 'Иркутск') {
    ...
    if ($(this).closest('.checkout__desc-wrap').find('#js-pickup input').is(':checked')) {
      btnTwo.removeClass('btn-dis');
    }

    if ($(this).closest('.checkout__desc-wrap').find('#js-curier input').is(':checked')) {
...
// console.log(newDate + ' - ' + tomorrow + ' ---' + afterTomorrow);
// datetime picker

$.datetimepicker.setLocale('ru'); // Появление календаря при нажатии на кнопку "Указать точное время" для Safari и Firefox
// @param strWrapperClass - класс формы-обертки с группой радиобаттонов
// @param strRadioId - id чекбокса, при активном состоянии
// @param strHiddenInputId - id текстового инпута, при состоянии focus которой календарь появляется в Safari и FF
...
$('#datetimepicker').datetimepicker({
  ...
  onChangeDateTime: function onChangeDateTime() {
    var strTimeValue = $('#datetimepicker').val();
    $(".exact-time__text").text(strTimeValue);
  }
});
...
__webpack_require__(/*! ./vendor/jquery.datetimepicker.full.min.js */ "./src/js/vendor/jquery.datetimepicker.full.min.js");
  ...
  o = 864e5, i = 3600, e = function e(_e, t) {
    ...
    for (e = e || {}, t = 1; t < arguments.length; t++) {
      if (r = arguments[t]) for (var n in r) {
        r.hasOwnProperty(n) && ("object" == _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(r[n]) ? _a(e[n], r[n]) : e[n] = r[n]);
      }
    }
    ...
    parseDate: function parseDate(t, a) {
      ...
      switch (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(t)) {
        case "number":
          return new Date(t);
...
!function (e) {
  "function" == typeof define && __webpack_require__(/*! !webpack amd options */ "./node_modules/webpack/buildin/amd-options.js") ? define(["jquery", "jquery-mousewheel"], e) : "object" == (typeof exports === "undefined" ? "undefined" : _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(exports)) ? module.exports = e(__webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js")) : e(jQuery);
}(datetimepickerFactory), function (e) {
  "function" == typeof define && __webpack_require__(/*! !webpack amd options */ "./node_modules/webpack/buildin/amd-options.js") ? define(["jquery"], e) : "object" == (typeof exports === "undefined" ? "undefined" : _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(exports)) ? module.exports = e : e(jQuery);
}(function (e) {
  function t(t) {
